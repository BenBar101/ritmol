  ...
  return (
    <Modal onClose={onClose}>
      <div style={{ padding: "32px", textAlign: "center", fontFamily: "'Share Tech Mono', monospace" }}>
        <div style={{ fontSize: "14px", color: "#ccc", letterSpacing: "3px", marginBottom: "12px" }}>DAILY LOGIN</div>
  ...
  return (
    <Modal onClose={onClose}>
      <div style={{ padding: "24px", fontFamily: "'Share Tech Mono', monospace" }}>
        <div style={{ fontSize: "14px", color: "#ccc", letterSpacing: "3px", marginBottom: "20px", fontWeight: "bold" }}>SLEEP ANALYSIS</div>
          ...
          <div style={{ display: "flex", gap: "6px" }}>
            {[1,2,3,4,5].map((q) => (
              <button
                ...
                background: quality >= q ? "#fff" : "transparent", color: quality >= q ? "#000" : "#ccc",
          ...
          <div style={{ display: "flex", gap: "6px" }}>
            {[true, false].map((v) => (
              <button
                ...
                background: rested === v ? "#fff" : "transparent", color: rested === v ? "#000" : "#ccc",
                fontFamily: "'Share Tech Mono', monospace", fontSize: "16px", fontWeight: "bold",
                minHeight: "48px",
              }}
              >
...
export function ScreenTimeModal({ period, onClose, onSubmit }) {
  ...
  return (
    <Modal onClose={onClose}>
      <div style={{ padding: "24px", fontFamily: "'Share Tech Mono', monospace" }}>
        <div style={{ fontSize: "14px", color: "#ccc", letterSpacing: "3px", marginBottom: "8px", fontWeight: "bold" }}>SCREEN TIME LOG</div>
  ...
  return (
    <Modal onClose={onClose}>
      <div style={{ padding: "24px", fontFamily: "'Share Tech Mono', monospace", background: sStyle.background }}>
        ...
        <div style={{ fontSize: "14px", color: "#ccc", letterSpacing: "3px", marginBottom: "20px", fontWeight: "bold" }}>LOG STUDY SESSION</div>
...
export function LevelUpModal({ data, onClose }) {
  return (
    <div style={{
      ...
      <div style={{ fontSize: "14px", color: "#ccc", letterSpacing: "4px", marginBottom: "20px", fontWeight: "bold" }}>SYSTEM ALERT</div>
      <div style={{ fontSize: "20px", color: "#fff", letterSpacing: "3px", marginBottom: "12px" }}>LEVEL UP</div>
    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: "14px", color: "#ccc", marginTop: "4px", lineHeight: "1.5" }}>{sanitizeForDisplay(String(toast.desc ?? ''), 300)}</div>
      ...
      <div style={{ marginTop: "8px", height: "4px", background: "#333" }}>
